                ...
                for col_index, col in enumerate(row):
                    if col != '-1':
                        ...
                        if style == 'grass':
                            ...
                            Tile((x, y), [
                                 self.obstacle_sprites, self.visible_sprites,self.attackable_sprites], 'grass', random_grass_image)
                        
                            # create grass
                        if style == 'object':
                            surf = graphics['objects'][int(col)]
                            Tile((x, y), [self.obstacle_sprites,
                                 self.visible_sprites], 'object', surf)
