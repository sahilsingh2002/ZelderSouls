...
class UI:
    def __init__(self):
        ...
        for magic in magic_data.values():
            path1 = magic['graphic']
            magic = pygame.image.load(path1).convert_alpha()
    ...
    def weapon_overlay(self, weapon_index,has_switched):
        bg_rect = self.selection_box(7, 635,has_switched)  # weapon
        weapon_surf = self.weapon_graphics[weapon_index]
        weapon_rect = weapon_surf.get_rect(center=bg_rect.center)
        self.display_surface.blit(weapon_surf, weapon_rect)
        
    def magic_overlay(self, magic_index,has_switched):
        bg_rect = self.selection_box(75, 638,has_switched)  # weapon
    ...
    def display(self, player):
        ...
        # pygame.draw.rect(self.display_surface,'white',self.energy_bar_rect)
        self.show_bar(
        ...
        # self.selection_box(90, 638)  # magic
